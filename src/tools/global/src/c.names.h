...
#define ga_fdot_                           F77_FUNC_(ga_fdot, GA_FDOT)
#define ga_fence_                          F77_FUNC_(ga_fence, GA_FENCE)
#define ga_fgop_                           F77_FUNC_(ga_fgop, GA_FGOP)
...
#define ga_lgop_                           F77_FUNC_(ga_lgop, GA_LGOP)
...
#define ga_pgroup_fgop_                    F77_FUNC_(ga_pgroup_fgop, GA_PGROUP_FGOP)
...
#define ga_pgroup_lgop_                    F77_FUNC_(ga_pgroup_lgop, GA_PGROUP_LGOP)
...
#define ga_type_gop_                       F77_FUNC_(ga_type_gop, GA_TYPE_GOP)
...
#define gai_dot_                           F77_FUNC_(gai_dot, GAI_DOT)
#define gai_dot_patch_                     F77_FUNC_(gai_dot_patch, GAI_DOT_PATCH)
#define gai_cdot_                          F77_FUNC_(gai_cdot, GAI_CDOT)
#define gai_zdot_                          F77_FUNC_(gai_zdot, GAI_ZDOT)
#define nga_acc_common_                    F77_FUNC_(nga_acc_common, NGA_ACC_COMMON)
...
#define nga_fdot_patch_                    F77_FUNC_(nga_fdot_patch, NGA_FDOT_PATCH)
#define nga_fill_patch_                    F77_FUNC_(nga_fill_patch, NGA_FILL_PATCH)
#define nga_gather_                        F77_FUNC_(nga_gather, NGA_GATHER)
#define nga_get_common_                    F77_FUNC_(nga_get_common, NGA_GET_COMMON)
...
#define ngai_dot_patch_                    F77_FUNC_(ngai_dot_patch, NGA_DOT_PATCH)
